...
<body style="" screen_capture_injected="true">
    ...
    <div class="g-wrap">
        ...
        <div class="u-tab">
            <ul class="cc">
              <li class="current"><a href="javascript:;">数据备份</a></li>
            </ul>
        </div>
        <!-- 数据表格 -->
            ...
            <table width="100%">
                ...
                <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$table): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td class="action">
                                <a class="J_ajax_get no-refresh" href="<?php echo U('optimize?tables='.$table['name']);?>">优化表</a>&nbsp;
                                <a class="J_ajax_get no-refresh" href="<?php echo U('repair?tables='.$table['name']);?>">修复表</a>
                            </td>
        ...
        <div class="btn_wrap">
            ...
            <a id="export" class="btn btn_submit" href="javascript:;" autocomplete="off">立即备份</a>
            <a id="optimize" class="btn btn_submit" href="<?php echo U('optimize');?>">优化表</a>
            <a id="repair" class="btn btn_submit" href="<?php echo U('repair');?>">修复表</a>
            </div>
        </div>
        <!-- 分页 -->
        <div class="page">
