...
<body style="" screen_capture_injected="true">
	...
	<div class="g-wrap">
		...
		<div class="u-tab">
		    <ul class="cc">
		      <li class="current"><a href="javascript:;">钩子列表</a></li>
		    </ul>
		</div>
		<!-- 数据表格 -->
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								...
								<a class="confirm J_ajax_get" title="删除" href="<?php echo U('delhook?id='.$vo['id']);?>">删除</a>
							</td>
		...
		<div class="btn_wrap">
            ...
            <?php if (IS_ROOT): ?>
				<a class="btn btn_submit" href="<?php echo U('addhook');?>">新 增</a>
			<?php endif ?>
            </div>
        </div>
		<!-- 分页 -->
