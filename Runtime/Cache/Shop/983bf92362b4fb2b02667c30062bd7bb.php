	...
	<div class="g-wrap">
		...
		<div class="u-tab">
		    <ul class="cc">
		      ...
		      <li><a target="_self" href="<?php echo U('ShopShipping/add',array('term'=>$term['term_id']));?>">添加货运方式</a></li>
		    </ul>
		</div>
	    ...
	    <div class="table_list u-table">
		    ...
		    <tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><a href="<?php echo U('ShopShipping/index?cate_id='.$vo['category_id'].'&pid='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a></td>
					<td><?php echo ($vo["price"]); ?></td>
					<td><?php echo ($vo["desc"]); ?></td>
					<td>
						<a href="<?php echo U('ShopShipping/edit?cate_id='.$vo['category_id'].'&id='.$vo['id']);?>">编辑</a>
						<a href="<?php echo U('ShopShipping/delete?ids='.$vo['id']);?>" class="confirm J_ajax_get">删除</a>
		                </td>
		...
		<div class="btn_wrap">
			...
			<button class="btn J_ajax_post confirm" target-form="ids" url="<?php echo U("ShopShipping/delete",array("status"=>-1));?>">删 除</button>
            </div>
        </div>
		<!-- 分页 -->
	    <div class="page">
